...
( commenting all the BRK stuff since I don't know how that works on x64
TODO: FIXME, can use sbrk instead
(
...
HEX
: =NEXT		( addr -- next? )
	   DUP C@ 48 <> IF DROP FALSE EXIT THEN \ was the lodsl commend just one byte on i386?
...
: WELCOME
	S" TEST-MODE" FIND NOT IF
		...
		( unused depends on commented out BRK code 
